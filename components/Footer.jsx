  ...
  return (
    <footer className="bg-[#202020] text-white pt-12 pb-8 mt-16">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        {/* Contact Info */}
        <div>
          <h4 className="font-semibold text-[18px] uppercase tracking-widest text-white mb-5">
            Contact Info
          </h4>
          <ul className="space-y-3 text-sm text-[#E5E5E5]">
            <li className="flex items-center gap-2 text-[18px]">
              ...
              >
                <span className="text-[#467BE7] mr-6">Pakistan</span>
                03554963760
              </a>
            </li>
            <li className="flex items-center gap-2 text-[18px]">
              ...
              <a
                ...
                className="text-[#E5E5E5] hover:text-orange-400 transition-colors"
              >
                <span className="text-[#467BE7] mr-6">Email</span>
          ...
          <ul className="space-y-2 text-sm text-[#E5E5E5]">
            {[
              ...
              <li key={item}>
                <Link
                  href="#"
                  className="hover:text-orange-400 transition-colors leading-[30.6px] mb-1 text-[18px]"
                >
                  {item}
                </Link>
              </li>
            ...
            {["Privacy Policy", "Terms and Conditions", "Contact Us"].map(
              (item) => (
                <li key={item}>
                  <Link
                    href="#"
                    className="hover:text-orange-400 transition-colors text-[18px] "
                  >
                    {item}
                  </Link>
                </li>
        ...
        {/* Follow Us */}
        <div>
          <h4 className="  uppercase tracking-widest text-white mb-5 font-semibold text-[18px] ">
            Follow Us
          </h4>
